  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#FAFAFA] font-sans antialiased overflow-x-hidden text-slate-900">
          ...
          <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
            ...
            <a className="flex items-center gap-2.5 group" href="#">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-medium tracking-tight bg-slate-100 text-slate-500">
                  v2.4
                </span>
              </div>
            </a>
            ...
            <nav className="hidden md:flex items-center gap-7 text-[13px] font-medium text-slate-600">
              <a className="hover:text-slate-900 transition-colors" href="#product">
                Product
              </a>
              ...
              <Link
                className="hover:text-slate-900 transition-colors text-primary font-semibold"
                to="/pricing"
              >
                Pricing
              </Link>
              <a className="hover:text-slate-900 transition-colors" href="#economics">
                Clinic Economics
              </a>
            ...
            <div className="flex items-center gap-3">
              <Link
                className="hidden sm:inline-flex px-3 py-1.5 text-xs font-medium text-slate-600 hover:text-slate-900 transition-colors"
                to="/login"
              >
                Sign in
              </Link>
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="inline-flex items-center justify-center gap-1.5 px-3.5 py-1.5 rounded-lg text-xs font-medium text-white bg-slate-900 hover:bg-slate-800 shadow-md hover:shadow-lg transition-all duration-150 cursor-pointer"
                href="#trial"
              >
        ...
        <main className="relative pt-16 sm:pt-24 pb-20 overflow-hidden">
          <div className="absolute inset-0 pointer-events-none overflow-hidden -z-10">
            <img
              alt="Fluid ambient silk background"
              className="w-full h-[850px] object-cover object-top opacity-35 mix-blend-multiply filter blur-[0.5px]"
              src="https://lh3.googleusercontent.com/aida/AEtjO1XP2iiugfuOHhw9iuthBtXOEcSGHjxPB66G5aVQ5IWQR43yGuU3seSDgzK8sL4GQ0cMmv7k7f9M5k3X75yqRu9JulttmnaBDpCvHy7g0LPD8997tqi12nIM_paPCRJfSWAWUGu6kMxyHIw0MEnDyy_dHVTxKsPOb-GWG239A79TsexitSb8oPp6Ba9iD2GcecfP94D4KUbRz0q4tTExxU-zAeuq8bb1A4PLOlcoowzuLazssZBLZrlZSBJ1"
            />
            <div className="absolute inset-0 bg-gradient-to-b from-white/60 via-[#FAFAFA]/40 to-[#FAFAFA]"></div>
          ...
          >
            ...
            <p className="text-base sm:text-lg text-slate-600 font-normal leading-relaxed max-w-2xl mx-auto text-balance mb-9 font-sans">
              The automated WhatsApp attendance engine for premier aesthetic clinics and luxury
              wellness spas. Eliminate ghosted chairs with 2-hour verified reminders, frictionless
              client self-rescheduling, and instant waitlist backfilling.
            </p>
            {/* Action Cluster */}
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <motion.a
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="w-full sm:w-auto px-5 py-2.5 rounded-lg font-medium text-sm text-white bg-slate-900 hover:bg-slate-800 shadow-subtle transition-all flex items-center justify-center gap-1.5"
                href="#trial"
              >
              ...
              <motion.a
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="w-full sm:w-auto px-5 py-2.5 rounded-lg font-medium text-sm text-slate-700 hover:text-slate-900 bg-white border border-slate-200/90 shadow-subtle hover:bg-slate-50 transition-all flex items-center justify-center gap-2"
                href="#walkthrough"
              >
            ...
            <div className="mt-10 flex items-center justify-center gap-2.5 text-xs text-slate-500">
              ...
              <span>
                <strong className="font-semibold text-slate-800">4.9/5 rated</strong> across 2,400+
                aesthetic clinics &amp; wellness studios
              </span>
            </div>
                ...
                <div className="px-4 py-2.5 bg-slate-50/70 border-b border-slate-100 flex items-center justify-between text-xs">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="ml-2 font-mono text-[11px] text-slate-400">
                      rebook.app/aura-wellness/schedule
                    </span>
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center justify-between pb-1">
                      <div>
                        <h3 className="text-sm font-semibold text-slate-900">
                          Today's Treatment Dispatch
                        </h3>
                        <p className="text-xs text-slate-400 mt-0.5">
                          Thursday, Oct 24 • 18 of 20 Slots Filled
                        </p>
                      </div>
                        ...
                        <div className="flex items-center gap-3.5">
                          ...
                          <div>
                            ...
                            <div className="text-[11px] text-slate-500 mt-0.5">
                              HydraFacial Deluxe • Dr. Priya (Suite 02)
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="p-3.5 rounded-lg border border-indigo-100/80 bg-indigo-50/20 hover:border-indigo-200 transition-all flex items-center justify-between">
                        <div className="flex items-center gap-3.5">
                          ...
                          <div>
                            ...
                            <div className="text-[11px] text-slate-500 mt-0.5">
                              Deep Tissue Therapy • Therapist Vikram
                            </div>
                          </div>
                        </div>
                        <div className="text-right">
                      ...
                      <div className="p-3.5 rounded-lg border border-slate-100 hover:border-slate-200 bg-white transition-all flex items-center justify-between">
                        <div className="flex items-center gap-3.5">
                          ...
                          <div>
                            ...
                            <div className="text-[11px] text-slate-500 mt-0.5">
                              Keratin Treatment • Stylist Sunita (Chair 04)
                            </div>
                          </div>
                        </div>
                        <div className="text-right">
                    ...
                    <div className="rounded-xl border border-slate-200 bg-white shadow-card overflow-hidden max-w-sm w-full">
                      ...
                      <div className="px-3.5 py-2.5 bg-[#075E54] text-white flex items-center justify-between">
                        <div className="flex items-center gap-2.5">
                          <div className="w-7 h-7 rounded-full bg-emerald-800 flex items-center justify-center font-bold text-[10px]">
                            AW
                          </div>
                          <div>
                        ...
                        <span className="material-symbols-outlined text-xs text-emerald-200">
                          more_vert
                        </span>
                      </div>
                      {/* Chat Surface */}
                      <div className="p-3.5 whatsapp-chat-bg space-y-2.5 text-xs min-h-[300px]">
                        ...
                        <div className="bg-white rounded-lg p-3 max-w-[95%] shadow-subtle space-y-2 border-l-2 border-emerald-600">
                          ...
                          <p className="leading-relaxed text-slate-700 text-[11px]">
                            Hi <span className="font-semibold text-slate-900">Priya</span>, your{' '}
                            <span className="font-semibold text-slate-900">HydraFacial Deluxe</span>{' '}
                            with Dr. Priya is scheduled for today at{' '}
                            <span className="font-semibold text-slate-900">10:00 AM</span>.
                          </p>
        ...
        <motion.section
          ...
          transition={{ duration: 0.7, ease: 'easeOut' }}
          className="py-12 border-y border-slate-200/60 bg-white"
        >
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-6 gap-6 items-center justify-center text-slate-700 text-center">
              <div className="font-medium tracking-widest text-xs uppercase opacity-70 hover:opacity-100 transition-opacity">
                AURA WELLNESS
              </div>
              <div className="font-medium tracking-widest text-xs uppercase opacity-70 hover:opacity-100 transition-opacity">
                ÉSTHÉTIQUE DERMA
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="max-w-2xl mb-14">
              ...
              <p className="text-slate-500 text-sm mt-2 leading-relaxed">
                Cluttered SMS inboxes and friction-heavy phone calls encourage patients to ghost.
                WhatsApp native interaction removes all hesitation.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-6 rounded-xl border border-slate-200/80 bg-[#FAFAFA] space-y-3">
                <div className="text-xs font-medium text-slate-500">
                  Read &amp; Deliverability Rate
                </div>
                <div className="text-3xl font-semibold text-slate-900 tracking-tight">98.4%</div>
                <p className="text-xs text-slate-500 leading-relaxed">
                  Versus 12% SMS delivery. Rebook delivers directly as an official verified Meta
                  WhatsApp push notification read within 5 minutes.
                </p>
                <div className="pt-2 text-[11px] font-medium text-emerald-700 flex items-center gap-1">
                  <span className="material-symbols-outlined text-[13px]">check_circle</span> 8.2x
                  higher than legacy carrier SMS
                </div>
              </div>
              <div className="p-6 rounded-xl border border-slate-200/80 bg-[#FAFAFA] space-y-3">
                ...
                <p className="text-xs text-slate-500 leading-relaxed">
                  Versus 15 minutes of front-desk phone tag. Clients tap one button to immediately
                  claim alternative open appointment windows.
                </p>
                <div className="pt-2 text-[11px] font-medium text-indigo-700 flex items-center gap-1">
                  <span className="material-symbols-outlined text-[13px]">bolt</span> Zero staff
              ...
              <div className="p-6 rounded-xl border border-slate-200/80 bg-[#FAFAFA] space-y-3">
                ...
                <p className="text-xs text-slate-500 leading-relaxed">
                  Average gross revenue saved per treatment chair each month by turning empty
                  vacated slots into confirmed visits.
                </p>
                <div className="pt-2 text-[11px] font-medium text-emerald-700 flex items-center gap-1">
                  <span className="material-symbols-outlined text-[13px]">trending_up</span>{' '}
                  Measured across 300+ surveyed clinics
                </div>
              </div>
            </div>
          </div>
        ...
        <motion.section
          ...
          viewport={{ once: true, margin: '-50px' }}
          transition={{ duration: 0.7, ease: 'easeOut' }}
          className="py-20 border-t border-slate-100 bg-[#FAFAFA]"
          id="how-it-works"
        >
          <div className="max-w-6xl mx-auto px-6">
            <div className="max-w-2xl mb-14">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="p-6 rounded-xl border border-slate-200/90 bg-white shadow-subtle flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-base font-semibold text-slate-900 mt-2 mb-2">
                    The 120-Minute Smart Dispatch
                  </h3>
                  <p className="text-xs text-slate-500 leading-relaxed">
                    Reminders sent 24 hours prior are forgotten. Rebook notifies patients 2 hours
                    before the session with navigation, valet pin, and practitioner room details.
                  </p>
                </div>
              ...
              <div className="p-6 rounded-xl border border-slate-200/90 bg-white shadow-subtle flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-base font-semibold text-slate-900 mt-2 mb-2">
                    Frictionless WhatsApp Rescheduling
                  </h3>
                  <p className="text-xs text-slate-500 leading-relaxed">
                    Patients who face last-minute conflicts can instantly select alternative
                    openings without needing to call reception or feel uncomfortable.
                  </p>
                </div>
                <div className="mt-6 pt-4 border-t border-slate-100 flex items-center justify-between text-xs text-slate-400">
              ...
              <div className="p-6 rounded-xl border border-slate-200/90 bg-white shadow-subtle flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-base font-semibold text-slate-900 mt-2 mb-2">
                    Instant Waitlist Auto-Backfill
                  </h3>
                  <p className="text-xs text-slate-500 leading-relaxed">
                    When a client reschedules, the newly vacated slot is immediately offered via
                    discrete WhatsApp alert to prioritized waitlisted clients.
                  </p>
                </div>
                <div className="mt-6 pt-4 border-t border-slate-100 flex items-center justify-between text-xs text-slate-400">
            ...
            {/* Integrations strip */}
            <div
              className="mt-10 p-5 rounded-xl border border-slate-200/80 bg-white shadow-subtle flex flex-col sm:flex-row items-center justify-between gap-4"
              id="integrations"
            >
              <div className="flex items-center gap-3 text-xs text-slate-600">
                ...
                <span className="text-slate-400">
                  Fresha, Zenoti, Google Calendar, Calendly &amp; Custom Webhooks
                </span>
              </div>
              <a
        ...
        <motion.section
          ...
          viewport={{ once: true, margin: '-50px' }}
          transition={{ duration: 0.7, ease: 'easeOut' }}
          className="py-20 bg-white border-t border-slate-200/70 relative"
        >
          <div className="absolute inset-0 pointer-events-none overflow-hidden -z-10">
            <img
              alt="Luxury aesthetic clinic interior architecture"
              className="w-full h-full object-cover object-center opacity-15 filter saturate-75"
              src="https://lh3.googleusercontent.com/aida/AEtjO1UsDajX5zg_erVBc5UoC7N8Z6bNtJUUVDWpANw-s8OSa9bJ-NDKBvhOtE6P3jmXhO2u9eHiyh7CPPHyuGicgGdSbbne6thqX6D3t3ZQ-EL1nQKgEYUWWva1A4-06vt6-yFeAfYiDqk3WVDeHDQF2RfmICJhw9shfO1fB-CGV8rFtWWn38FmXY475Bx8_gDu8TjgfsCUla3rQ-FE8TKQOSNUsIyUY_U_F9GgKGJmOcWjTkLElKvFtqGIBu-L"
            />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
              ...
              <div className="lg:col-span-5 space-y-6">
                <div>
                  ...
                  <p className="text-slate-500 text-sm mt-3 leading-relaxed">
                    When a patient no-shows, your clinic still absorbs lease, utility, and
                    practitioner retainer costs. Rebook ensures treatment chairs generate expected
                    revenue.
                  </p>
                </div>
                {/* Real Clinic Quote */}
                <div className="p-5 rounded-xl border border-slate-200/80 bg-[#FAFAFA] space-y-3 backdrop-blur-md">
                  <p className="text-xs text-slate-600 italic leading-relaxed">
                    "Before Rebook, our six treatment rooms averaged 3 ghosted slots every
                    day—costing over ₹1,80,000 every month. Within two weeks of turning on WhatsApp
                    automated reminders, our no-show rate collapsed below 1.5%."
                  </p>
                  <div className="flex items-center gap-2.5 pt-2 border-t border-slate-200/60">
                    ...
                    <div>
                      <div className="text-xs font-semibold text-slate-900">
                        Dr. Radhika Nambiar, MD
                      </div>
                      <div className="text-[11px] text-slate-400">
                        Founder &amp; Medical Director, SkinAura Aesthetics
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="lg:col-span-7 bg-[#FAFAFA] rounded-xl border border-slate-200/80 p-6 sm:p-7 shadow-card">
                ...
                <div className="p-4 rounded-lg bg-white border border-slate-200 grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="text-[11px] text-slate-400 mt-0.5">
                      Directly added to clinic net margin
                    </div>
                  </div>
                  <div className="sm:border-l sm:border-slate-100 sm:pl-4">
                    ...
                    <div className="text-[11px] text-slate-400 mt-0.5">
                      Manual phone follow-ups eliminated
                    </div>
                  </div>
                </div>
                <div className="mt-4 flex items-center justify-between text-xs text-slate-400 pt-1">
                  ...
                  <a className="text-slate-800 font-medium hover:underline" href="#trial">
                    Deploy in 3 minutes →
                  </a>
                </div>
              </div>
        ...
        <motion.section
          ...
          viewport={{ once: true, margin: '-50px' }}
          transition={{ duration: 0.7, ease: 'easeOut' }}
          className="py-20 bg-[#FAFAFA] border-t border-slate-200/60"
          id="trial"
        >
          <div className="max-w-4xl mx-auto px-6 text-center">
            <div className="p-8 sm:p-12 rounded-2xl bg-white border border-slate-200/90 shadow-card">
              ...
              <p className="text-slate-500 text-sm sm:text-base max-w-lg mx-auto mb-8 leading-relaxed">
                Connect your appointment calendar in 3 minutes. Turn on verified WhatsApp reminders,
                and eliminate empty treatment chairs tomorrow morning.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                <motion.a
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="w-full sm:w-auto px-5 py-2.5 rounded-lg font-medium text-sm text-white bg-slate-900 hover:bg-slate-800 shadow-md transition-all flex items-center justify-center gap-1.5"
                  href="#"
                >
                  <span>Start 14-Day Free Trial</span>
                  <span className="material-symbols-outlined text-sm">arrow_forward</span>
                ...
                <motion.a
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="w-full sm:w-auto px-5 py-2.5 rounded-lg font-medium text-sm text-slate-700 hover:text-slate-900 bg-white border border-slate-200 shadow-sm hover:shadow transition-all flex items-center justify-center gap-2"
                  href="#demo"
                >
                ...
                <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  <Link
                    to="/pricing"
                    className="w-full sm:w-auto px-5 py-2.5 rounded-lg font-medium text-sm text-slate-700 hover:text-slate-900 bg-slate-50 border border-slate-200 shadow-sm hover:shadow transition-all flex items-center justify-center gap-2"
                  >
        ...
        <footer className="bg-white border-t border-slate-200/70 py-10 text-xs text-slate-500">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="mt-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-[11px] text-slate-400">
              <div>
                © 2025 Rebook Technologies, Inc. WhatsApp and Meta are registered trademarks of Meta
                Platforms, Inc.
              </div>
